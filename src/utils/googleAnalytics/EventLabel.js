class EventLabel{   
    static MERCHANT_CARD = "Merchant Card"
    static CATEGORY_FILTER = "Category Filter"
    static REGISTER_BUTTON = "Register Button"
    static HOME_BUTTON = "Home Button"
    static ABOUT_US_BUTTON = "About us Button"
    static REGISTER_BUTTON = "Register Button"
    static EMAIL_LINK = "Email Link"
    static INSTAGRAM_LINK = "Instagram Link"
    static LINKEDIN_LINK = "LinkedIn Link"
